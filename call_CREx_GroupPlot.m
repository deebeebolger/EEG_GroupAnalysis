...
% GPcfg.Condnom should be a cell array of 2 or 3 strings corresponding to the condition names.
...
GPcfg.currdir='F:\BLRI\EEG\Projets_en_cours\projet_MorphemB\EEG_Data\';
GPcfg.Condnom1= {'Word-NS','Word-PS'};                                                                                                          % 'MAct' 'Num' 'Trans' Declare the conditions to be compared; need to have same names as condition folders.
GPcfg.Condnom2={};  % {'NOL-T0' 'NOL-T0'};                                                                                                                 % If there are subgroups...
